...
(function( window, document, undefined ) {
  ...
  if( !window.FuckMyChars ) {
    ...
    ctag.setAttribute('href', 'http://mhgbrown.github.io/fuck-my-chars/css/fuck-my-chars.css');
  ...
  function loadScript() {
    ...
    stag.setAttribute( 'src', 'http://mhgbrown.github.io/fuck-my-chars/js/fuck-my-chars.js' );
